<template>
    <nav :class="[userAgent ? 'pt-4' : '']">
        ...
        <div :class="[!userAgent ? 'border-b border-gray-400 ' : '', '']">
        ...
        <router-link to="/reports" :class="[!userAgent ? 'border-b border-gray-400' : '', 'flex items-center py-2 hover:text-blue-600 text-sm']">
        ...
        <router-link to="/logout" :class="[!userAgent ? 'border-b border-gray-400 ' : '', 'flex items-center py-2 hover:text-blue-600 text-sm']">
